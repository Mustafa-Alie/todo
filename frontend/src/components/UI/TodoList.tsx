...
//     <>
//       <ul
//         className={`mt-4 flex flex-col rounded-lg ${theme === "light" ? "bg-white shadow-xl shadow-gray-200" : "bg-slate-800"}`}
//       >
//         {localTodos.map((todo) => (
//           <li
//             className={`group flex items-center gap-4 border-b p-2 pr-4 text-xl ${theme === "light" ? "border-b-gray-400 text-gray-700" : "border-b-gray-700 text-gray-400"} `}
//             key={todo.id}
//           >
//             <div
//               className={`ms-2 flex min-h-5 min-w-5 cursor-pointer items-center justify-center rounded-full border border-gray-400 ${todo.completed ? "bg-linear-to-br from-cyan-400 to-violet-500" : ""} `}
//               data-completed={todo.id}
//               onClick={() => updateTodoCompletion(todo.id, setLocalTodos)}
//             >
//               <img
//                 alt="check icon"
...
//             <span
//               className={`max-w-[80%] shrink cursor-pointer p-2 ${theme === "light" ? "text-gray-700" : "text-gray-400"}`}
//               onClick={() => updateTodoCompletion(todo.id, setLocalTodos)}
//             >
//               {todo.content}
//             </span>
...
//         <li
//           className={`flex items-center justify-between gap-2 p-4 text-xs font-normal text-nowrap md:gap-4 ${theme === "light" ? "text-gray-500" : "text-gray-400"}`}
//         >
//           <p>
//             <span className="pr-1 font-extrabold">{localTodos.length}</span>
//             items left
//           </p>
...
//           <button
//             type="button"
//             className={`cursor-pointer p-1 ${theme === "light" ? "hover:text-gray-900" : "hover:text-gray-300"}`}
//           >
//             Clear Completed
//           </button>
//         </li>
...
//       <div
//         className={`mt-8 flex justify-center gap-8 rounded-lg p-2 md:hidden ${theme === "light" ? "bg-white text-gray-500 shadow-xl shadow-gray-200" : "bg-slate-800 text-gray-300"}`}
//       >
//         <button
//           type="button"
//           className={`cursor-pointer p-1 text-blue-600 ${theme === "light" ? "" : ""}`}
//         >
//           All
//         </button>
